...
const Menu = () => {
    ...
    function LoginCheck(){
        if(typeof userInfo.userId == "undefined"){
            ...
            return (
                <React.Fragment>
                    <Navbar.Text id="user-bar"><img width="25px" src={userInfo.picture} />{userInfo.userId}님</Navbar.Text>
        ...
        <section>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="mr-auto">
                    <NavLink className="nav-link" to="/saving/deposit" >예금</NavLink>
                    <NavLink className="nav-link" to="/saving/installment" >적금</NavLink>
