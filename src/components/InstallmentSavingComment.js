...
const InstallmentSavingComment = ({ commentList, userInfo, onCommentDelete, onCommentCreate, onCommentModify}) => {
                    ...
                    <React.Fragment>
                        <Toast style={{maxWidth:"none"}} onClose={(e) => onCommentDelete(e, element)} >
                            <Toast.Header closeButton={true}>
                                ...
                                &nbsp;&nbsp;
                                <img width="16px" src={editIcon} alt="editIcon" onClick={(e) => onCommentModify(e, element)} />
                            </Toast.Header>
...
export default InstallmentSavingComment;